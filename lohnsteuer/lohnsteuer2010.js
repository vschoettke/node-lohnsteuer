...
module.exports = function Lohnsteuer2010Big(args) {
    ...
    var KVSATZAG = new BigDecimal("0").setScale(5); // BigDecimal

    //  Beitragssatz des Arbeitnehmers zur Krankenversicherung (5 Dezimalstellen)
    var KVSATZAN = new BigDecimal("0").setScale(5); // BigDecimal
    ...
    var PVSATZAG = new BigDecimal("0").setScale(5); // BigDecimal

    //  Beitragssatz des Arbeitnehmers zur Pflegeversicherung (5 Dezimalstellen)
    var PVSATZAN = new BigDecimal("0").setScale(5); // BigDecimal
    ...
    function UPEVP() {
        if (KRV > 1) {
            ...
            VSP1 = (ZRE4VP.multiply(new BigDecimal("0.4"))).round(2, BigDecimal.RoundingModes.DOWN);

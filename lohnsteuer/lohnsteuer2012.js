...
// const BigDecimal
var RENTBEMESSUNGSGR_OST_2012 = new BigDecimal("57600");
// const BigDecimal
var RENTBEMESSUNGSGR_WEST = new BigDecimal("67200");
module.exports = function Lohnsteuer2012Big(args) {
    //  Stand: 2015-11-16
    //  ZIVIT Düsseldorf
    //   EINGABEPARAMETER
    ...
    function UPEVP() {
        if (KRV > 1) {
            ...
            if (KRV === 0) {
                ...
                if (ZRE4VP.compareTo(RENTBEMESSUNGSGR_OST_2012) === 1) {
    ...
    function MVSP() {
        if (ZRE4VP.compareTo(new BigDecimal("45900")) === 1) {
            ZRE4VP = new BigDecimal("45900");
        }
        if (PKV > 0) {
            if (STKL === 6) {
